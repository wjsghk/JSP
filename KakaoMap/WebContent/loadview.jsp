...
<head>
    ...
    .wrap_content {overflow:hidden;height:600px}
    .wrap_map {width:50%;height:100%;float:left;position:relative}
    .wrap_roadview {width:50%;height:100%;float:left;position:relative}
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=fbc93e69f3c00c4119a9f2e62b8fae8d"></script>
<script>
